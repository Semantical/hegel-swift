...
public struct DeferredGeneratorDefinition<Value>: ~Copyable {
    private final class Storage {
        var implementation: Generator<Value>?
    }
    ...
    public var generator: Generator<Value> {
        Generator { [storage] testCase in
    ...
    public consuming func set(_ generator: Generator<Value>) {
